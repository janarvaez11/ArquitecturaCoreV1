...
public class CrearClienteExcepcion extends RuntimeException {

    private final Integer codigoError;
    private static final Integer CODIGO_ERROR_DEFAULT = 2001;

    public CrearClienteExcepcion(String mensaje) {
        super(mensaje);
        this.codigoError = CODIGO_ERROR_DEFAULT;
    }

    public CrearClienteExcepcion(String mensaje, Integer codigoError) {
        super(mensaje);
