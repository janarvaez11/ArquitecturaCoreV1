...
public class ActualizarSucursalExcepcion extends RuntimeException {
    ...
    public ActualizarSucursalExcepcion(String nombreEntidad, String mensaje) {
        super(mensaje);
        this.codigoError = CODIGO_ERROR_DEFAULT;
    }

    public ActualizarSucursalExcepcion(String nombreEntidad, String mensaje, Integer codigoError) {
        super(mensaje);
